    ...
    <div class="container">
        ...
        <div class="right-side">
            ...
            <div class="login-card" id="loginCard">
                ...
                <h3 class="card-header-title">Lupa Password</h3>
                <p class="card-header-desc">Masukkan NIP atau Email yang terdaftar. Kami akan mengirimkan tautan untuk menyetel ulang password Anda.</p>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="email" name="email" value="{{ old('email') }}" class="form-input" placeholder="Masukkan NIP atau Email" required autofocus>
                        </div>
                    </div>
