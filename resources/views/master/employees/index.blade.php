...
@section('action_buttons')
    <a wire:navigate href="{{ route('master.employees.create') }}" class="btn btn-primary fw-semibold px-3 py-2 rounded-3 shadow-sm" style="background: linear-gradient(135deg, #1E40AF 0%, #2563EB 100%); border: none;">
