            ...
            <div class="card-body p-4">
                <form action="{{ route('master.assessment-indicators.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="name" id="name" rows="3" class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: Mampu menyelesaikan tugas pelayanan publik dengan tepat waktu dan responsif..." required>{{ old('name') }}</textarea>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="number" step="0.1" name="weight" id="weight" class="form-control @error('weight') is-invalid @enderror" value="{{ old('weight', 10) }}" placeholder="10">
